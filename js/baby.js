var babyObj = function()
{
	...
	this.babyTailCount = 0;//记录当前图片序号的变量，就是现在执行到哪一帧了。
...
babyObj.prototype.draw = function()
{
	...
	{
		this.babyTailCount = (this.babyTailCount + 1) % 8;//使得该变量在0~7间循环
	...
	if(this.babyEyeTimer > this.babyEyeInterval)
	{
		...
		{
			this.babyEyeInterval = 200;//闭眼持续两百毫秒
		}
	}
	...
	ctx1.save();
	//translate转移相对坐标
	ctx1.translate(this.x,this.y);//把原点转到小鱼身上
